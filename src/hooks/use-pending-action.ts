...
// ser lido de qualquer lugar (ex.: NavigationGuard) sem precisar de um
// Provider. Usado pra travar navegação enquanto qualquer save estiver de
// fato em andamento (ver src/components/navigation-guard.tsx).
